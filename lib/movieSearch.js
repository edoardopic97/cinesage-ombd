...
- Use exact official titles as they appear on IMDb. Never use working titles, sequel numbers (e.g. "Avatar 3"), or placeholder names (e.g. "Untitled Sequel"). Only include movies that have been officially released with a confirmed title.
